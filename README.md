...
|---------|-----------|------------|
| Sneha Malhotra | Arena Architect, Omni-Red | Go, Kubernetes, Docker, eBPF, Python, BCC |
| Moksha Malhotra | Referee, MARL | Python asyncio, Scapy, LLM, Ray RLlib, PettingZoo, Python |
| Tanvi Yadav | Omni-Blue, Observer | Kubernetes Network Policy, Python |
